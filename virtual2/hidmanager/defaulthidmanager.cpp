...
void DefaultHidManager::heControlUp() {


    emit signControlUp();
}

void DefaultHidManager::heControlDown() {

    emit signControlDown();
}

void DefaultHidManager::heControlRollLeft() {

    emit signControlRollLeft();
}

void DefaultHidManager::heControlRollRight() {

    emit signControlRollRight();
}

void DefaultHidManager::heControlPitchDown() {

    emit signControlPitchDown();
}

void DefaultHidManager::heControlPitchUp() {

    emit signControlPitchUp();
}

void DefaultHidManager::heControlYawLeft() {

    emit signControlYawLeft();
}

void DefaultHidManager::heControlYawRight() {

    emit signControlYawRight();
}

void DefaultHidManager::heControlPitchStop() {

    emit signControlPitchStop();
}

void DefaultHidManager::heControlRollStop() {

    emit signControlRollStop();
}


void DefaultHidManager::heControlYawStop() {

    emit signControlYawStop();
}

void DefaultHidManager::heControlHover() {

    emit signControlHover();
}
...
void DefaultHidManager::setupDefaultHidBindings() {
  ...
  QString ha_id_control_down =
      registerHidAction( "Controls",
                         "down",
                         "control down",
                         this, SLOT(heControlDown()),
                         OGL_TRIGGER);

  QString ha_id_control_roll_left =
      registerHidAction( "Controls",
                         "left",
                         "roll left",
                         this, SLOT(heControlRollLeft()),
                         OGL_TRIGGER);

  QString ha_id_control_roll_right =
      registerHidAction( "Controls",
                         "right",
                         "roll right",
                         this, SLOT(heControlRollRight()),
                         OGL_TRIGGER);

  QString ha_id_control_pitch_down =
      registerHidAction( "Controls",
                         "forwards",
                         "forth",
                         this, SLOT(heControlPitchDown()),
                         OGL_TRIGGER);

  QString ha_id_control_pitch_up =
      registerHidAction( "Controls",
                         "backwards",
                         "back",
                         this, SLOT(heControlPitchUp()),
                         OGL_TRIGGER);

  QString ha_id_control_yaw_left =
      registerHidAction( "Controls",
                         "Yaw left",
                         "upward left",
                         this, SLOT(heControlYawLeft()),
                         OGL_TRIGGER);

  QString ha_id_control_yaw_right =
      registerHidAction( "Controls",
                         "Yaw right",
                         "Upward right ",
                         this, SLOT(heControlYawRight()),
                         OGL_TRIGGER);

  QString ha_id_control_roll_stop_L =
      registerHidAction( "Controls",
                         "Stop roll L",
                         "stop roll",
                         this, SLOT(heControlRollStop()),
                         OGL_TRIGGER);

  QString ha_id_control_roll_stop_R =
      registerHidAction( "Controls",
                         "Stop roll R",
                         "stop roll ",
                         this, SLOT(heControlRollStop()),
  ...
  QString ha_id_control_pitch_stop_U =
      registerHidAction( "Controls",
                         "Stop pitch U",
                         "Quite",
                         this, SLOT(heControlPitchStop()),
                         OGL_TRIGGER);

  QString ha_id_control_pitch_stop_D =
      registerHidAction( "Controls",
                         "Stop pitch D",
                         "Quite",
                         this, SLOT(heControlPitchStop()),
  ...
  QString ha_id_control_yaw_stop_L =
      registerHidAction( "Controls",
                         "Stop yaw L",
                         "Quite",
                         this, SLOT(heControlYawStop()),
                         OGL_TRIGGER);

  QString ha_id_control_yaw_stop_R =
      registerHidAction( "Controls",
                         "Stop yaw R",
                         "Quite",
                         this, SLOT(heControlYawStop()),
                         OGL_TRIGGER);
  QString ha_id_control_hover =
        registerHidAction( "Controls",
                           "Hover",
                           "Auto adjust throttle to hover",
                           this, SLOT(heControlHover()),
                           OGL_TRIGGER);
  ...
  // Control
  registerHidMapping( ha_id_control_up,                   new KeyPressInput( Qt::Key_5, Qt::KeypadModifier));
  registerHidMapping( ha_id_control_down,                 new KeyPressInput( Qt::Key_0, Qt::KeypadModifier));
  registerHidMapping( ha_id_control_pitch_down,           new KeyPressInput( Qt::Key_8, Qt::KeypadModifier));
  registerHidMapping( ha_id_control_pitch_up,             new KeyPressInput( Qt::Key_2, Qt::KeypadModifier));
  registerHidMapping( ha_id_control_roll_left,            new KeyPressInput( Qt::Key_4, Qt::KeypadModifier));
  registerHidMapping( ha_id_control_roll_right,           new KeyPressInput( Qt::Key_6, Qt::KeypadModifier));
  registerHidMapping( ha_id_control_yaw_left,             new KeyPressInput( Qt::Key_1, Qt::KeypadModifier));
  registerHidMapping( ha_id_control_yaw_right,            new KeyPressInput( Qt::Key_3, Qt::KeypadModifier));
  registerHidMapping( ha_id_control_hover,                new KeyPressInput( Qt::Key_H));
  // Release
  registerHidMapping( ha_id_control_pitch_stop_D,         new KeyReleaseInput( Qt::Key_8, Qt::KeypadModifier));
  registerHidMapping( ha_id_control_pitch_stop_U,         new KeyReleaseInput( Qt::Key_2, Qt::KeypadModifier));
  registerHidMapping( ha_id_control_roll_stop_L,          new KeyReleaseInput( Qt::Key_4, Qt::KeypadModifier));
  registerHidMapping( ha_id_control_roll_stop_R,          new KeyReleaseInput( Qt::Key_6, Qt::KeypadModifier));
  registerHidMapping( ha_id_control_yaw_stop_L,           new KeyReleaseInput( Qt::Key_1, Qt::KeypadModifier));
  registerHidMapping( ha_id_control_yaw_stop_R,           new KeyReleaseInput( Qt::Key_3, Qt::KeypadModifier));
